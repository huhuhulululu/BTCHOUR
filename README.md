...
研究框架（合成盘对照、自举区间、样本外切分、真 tape 归档）：[`catalog/rules/research.md`](catalog/rules/research.md)。**016 起回放默认不再用分钟内 wick 判挂单成交**，历史那些 `6/6` 绿数字是旧成交模型付的钱，不是市场付的（[`findings.md`](catalog/research/findings.md)）。
