...
DEFAULT_VARIANTS = [
    ...
    # 017 control: the pre-017 clip stack on the coupon, so the 3.28c is re-measurable.
    {
        "name": "flex_clipstack",
        "playbook": "flex",
        "skip_after_loss": True,
        "impulse_wait_hold": False,
    },
...
def compact_run(summary: dict, name: str) -> dict:
    ...
    return {
        ...
        "impulse_taker": (summary.get("gates") or {}).get("impulse_taker"),
