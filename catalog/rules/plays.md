...
| `impulse_wait` | **dump coupon**。动量 ≤−$100，taker 过不了门，NO ask 还在 **$0.32–$0.42**、离现货 ≤$150。**挂 $0.25 maker**，不成交不算入账。已经砸到 29¢ 的不挂（纸盘 `T78499` 那刀）。淡了不撤；反弹里不填 | 10%–50% 带；8 分钟没到 +10% 就 scratch；已经跑出 +10% 才用 −80% 扛反弹。涨势不挂 YES |
