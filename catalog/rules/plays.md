...
| `impulse_wait` | **只做砸盘 NO**。动量 ≤−$100，taker 过不了门，卖一还在 $0.25–$0.48。**挂 $0.25 maker**，不成交不算入账。3 分钟印淡了不撤；只在砸盘还在时成交（反弹里不填） | 成交后走 10%–50% 带；**不用 −12% 止损 / 不用淡化 / 不用 40% 失效**；亏 **80%** 或进 TWAP 才砍。涨势不挂 YES——那三条 −50% 已经对照过 |
