...
| `impulse_wait` | **dump coupon**。**看见** NO ask **$0.32–$0.42**、离现货 ≤$150 就**挂 $0.25**，不要求砸盘动量才挂。已经翻到 ≥+$100 不挂。**成交仍只要 impulse ≤−$100**。缓存 42/42 小时都有近 ATM 32–42¢ NO；等 −$40/−$100 再挂会把大多数排队时间丢掉。纸盘 `AUG2616` 15:21 ET T78299 已是 0.36。已经砸到 29¢ 的不挂（纸盘 `T78499` 那刀）。淡了不撤；反弹里不填；**淡了 ask==rest 也不填**（纸盘 `AUG2604` 03:41 ET）。纸盘 `AUG2608` 第一次打出人手那种 clip：`T78299` rest 0.25 under 0.34，砸盘里成交，`t_clip` +18% | 10%–50% 带；8 分钟没到 +10% 就 scratch；已经跑出 +10% 才用 −80% 扛反弹。涨势不挂 YES |
