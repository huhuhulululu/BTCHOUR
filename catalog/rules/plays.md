...
| `impulse_wait` | **趋势 coupon**。下一个整点整条阶梯（$600）。**涨挂 YES（28–42¢），跌/静挂 NO（32–42¢）**。rest $0.25。成交只要同向 |impulse| ≥$100。29¢ NO 仍是飞刀。不做 15 分钟盘。不吃 taker。纸盘 `AUG2608` dump NO clip 仍算对 | 10%–50% 带；8 分钟没到 +10% 就 scratch；反手撤 |
